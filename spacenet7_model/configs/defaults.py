...
_C.BOUNDARY_SUBTRACT_COEFF = 0.25  # XXX: 0.50 may be better
_C.CONTACT_SUBTRACT_COEFF = 0.50  # XXX: 1.00 may be better
...
_C.WATERSHED_SEED_MIN_AREA_PIXEL = 4.0  # for 'watershed'  # XXX 0.00 may be better
