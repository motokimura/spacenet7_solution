...
_C.TRACKING_CHANGE_SEARCH_RADIUS_DYNAMICALLY = False
_C.TRACKING_SEARCH_RADIUS_COEFF = 2.0  # valid when TRACKING_CHANGE_SEARCH_RADIUS_DYNAMICALLY == True
_C.TRACKING_SEARCH_RADIUS_MIN = 6.0  # valid when TRACKING_CHANGE_SEARCH_RADIUS_DYNAMICALLY == True
_C.TRACKING_SEARCH_RADIUS_MAX = 12.0  # valid when TRACKING_CHANGE_SEARCH_RADIUS_DYNAMICALLY == True
