...
_C.TRACKING_SEARCH_RADIUS_PIXEL = 12.0  # XXX: not optimized, disabled when set to 0.0
_C.TRACKING_MAX_NUM_INTERSECT_POLYS = 9  # XXX: not optimized
_C.TRACKING_SHAPE_UPDATE_METHOD = 'none'  # ['none', 'latest']
_C.TRACKING_TRACK_FROM_LOW_VARIANCE = False
_C.TRACKING_REVERSE = False
_C.TRACKING_ENABLE_POST_INTERPOLATION = False
